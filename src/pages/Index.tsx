...
const slides = [
  {
    ...
    h1: "Hair worn like",
    h1italic: "heirloom.",
    sub: "Single-donor raw hair, HD lace, and silhouettes designed to be remembered. Pay in full or Pay Small Small.",
      ...
      <section className="section-dark relative min-h-[92vh] overflow-hidden flex items-center bg-[hsl(0_0%_6%)]">
        ...
        >
          <img
            ...
            className={`size-full object-cover ${s.pos}`}
          />
          ...
          <AnimatePresence mode="wait" custom={dir}>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-[11px] tracking-[0.3em] uppercase text-primary">{s.tag}</span>
              </div>

              <h1 className="font-display text-5xl sm:text-7xl lg:text-8xl leading-[0.95] mb-6">
                {s.h1}<br />
                <span className="text-gold italic">{s.h1italic}</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-3">
                <Button asChild variant="gold" size="xl">
                  <Link to={s.cta.to}>{s.cta.label} <ArrowRight className="size-4" /></Link>
                </Button>
